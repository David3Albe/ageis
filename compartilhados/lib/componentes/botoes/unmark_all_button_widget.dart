...
class UnmarkAllButtonWidget extends StatefulWidget {
  const UnmarkAllButtonWidget({
  ...
  @override
  State<UnmarkAllButtonWidget> createState() => _UnmarkAllButtonWidgetState();
}

class _UnmarkAllButtonWidgetState extends State<UnmarkAllButtonWidget> {
  bool hovered = false;
  bool valid = true;
