...
class TextFieldStringControllerWidget extends StatefulWidget {
  TextFieldStringControllerWidget({
  ...
  @override
  State<TextFieldStringControllerWidget> createState() =>
...
class _TextFieldStringWidgetState
    extends State<TextFieldStringControllerWidget> {
  bool visible = false;
  bool focused = false;
  String textChanged = '';
  String errorText = '';
