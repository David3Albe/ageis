...
class _ProprietarioPageFrmState extends State<ProprietarioPageFrm> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<ProprietarioPageFrmCubit, ProprietarioPageFrmState>(
      bloc: cubit,
      ...
      child: BlocBuilder<ProprietarioPageFrmCubit, ProprietarioPageFrmState>(
        bloc: cubit,
                      ...
                      children: [
                          ...
                          child: Row(
                            children: [
                              CustomCheckboxWidget(
                                ...
                                onClick: (value) => proprietario.ativo = value,
                                text: 'Ativo',
                              ),
                            ],
                          ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              CustomCheckboxWidget(
                                checked: proprietario.manutencaoLiberada,
                                onClick: (value) =>
                                    proprietario.manutencaoLiberada = value,
                          ...
                          Expanded(
                            child: BlocBuilder<LocalInstituicaoCubit,
                              ...
                              builder: (context, locaisState) {
                                ...
                                List<LocalInstituicaoModel> locaisAdicionado =
                                    [];
                                if (proprietario.proprietariosLocais != null) {
                                  for (final proprietarioLocal
                                      in proprietario.proprietariosLocais!) {
                                    final codLocal = proprietarioLocal.codLocal;

                                    if (locais.isNotEmpty) {
                                      final proprietarioLocalAdicionado = locais
                                          .where(
                                            (proprietarioLocal) =>
                                                proprietarioLocal.cod ==
                                                codLocal,
                                          )
                                          .firstOrNull;
                                      if (proprietarioLocalAdicionado != null) {
                                        locaisAdicionado
                                            .add(proprietarioLocalAdicionado);
                                      }
                                    }
                                  }
                                }
                                ...
                                return ListFieldWidget<LocalInstituicaoModel>(
                                  sourceList: locaisAdicionado,
                                  removeButton: false,
                                  onItemSelected: (selectedProprietarioLocal) {
                                    setState(() {
                          ...
                          Expanded(
                            child: BlocBuilder<LocalInstituicaoCubit,
                              ...
                              builder: (context, locaisState) {
                                ...
                                List<LocalInstituicaoModel> locaisDisponiveis =
                                    locais
                                        .where(
                                          (localInsituicao) => !proprietario
                                              .proprietariosLocais!
                                              .any(
                                            (proprietarioLocal) =>
                                                proprietarioLocal.codLocal ==
                            ...
                            child: ListButtonWidget(
                              ...
                              onPressed: () {
                                if (arsenalEstoqueRemover != null) {
                                  setState(() {
                                    if (proprietario.proprietariosArsenais !=
                                        null) {
                                ...
                                if (arsenalEstoqueAdicionar != null) {
                                  setState(() {
                                    ...
                                    ProprietarioArsenalModel
                                        proprietarioArsenal =
                                        ProprietarioArsenalModel.empty();
                          ...
                          Expanded(
                            child: BlocBuilder<ArsenalEstoqueCubit,
                              ...
                              builder: (context, arsenaisState) {
                                ...
                                List<ArsenalEstoqueModel> arsenaisAdicionado =
                                    [];
                                if (proprietario.proprietariosArsenais !=
                                    null) {
                                  for (final proprietarioArsenal
                                      in proprietario.proprietariosArsenais!) {
                                    final codEstoque =
                                        proprietarioArsenal.codEstoque;
                                    ...
                                    if (arsenais.isNotEmpty) {
                                      ...
                                      if (proprietarioArsenalAdicionado !=
                                          null) {
                                        arsenaisAdicionado
                                            .add(proprietarioArsenalAdicionado);
                                      }
                                    }
                                  }
                                }
                                ...
                                return ListFieldWidget<ArsenalEstoqueModel>(
                          ...
                          Expanded(
                            child: BlocBuilder<ArsenalEstoqueCubit,
                              ...
                              builder: (context, arsenaisState) {
                                ...
                                List<ArsenalEstoqueModel> arsenaisDisponiveis =
                                    arsenais
                                        .where(
                                          (arsenalEstoque) => !proprietario
