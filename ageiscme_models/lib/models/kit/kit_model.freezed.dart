...
KitModel _$KitModelFromJson(Map<String, dynamic> json) {
  return _KitModel.fromJson(json);
}
...
mixin _$KitModel {
  ...
  List<ItemModel>? get itens => throw _privateConstructorUsedError;
  set itens(List<ItemModel>? value) => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $KitModelCopyWith<KitModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $KitModelCopyWith<$Res> {
  factory $KitModelCopyWith(KitModel value, $Res Function(KitModel) then) =
      _$KitModelCopyWithImpl<$Res, KitModel>;
  @useResult
  $Res call(
      {int? cod,
      String? codBarra,
...
/// @nodoc
class _$KitModelCopyWithImpl<$Res, $Val extends KitModel>
    implements $KitModelCopyWith<$Res> {
  _$KitModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$KitModelImplCopyWith<$Res>
    implements $KitModelCopyWith<$Res> {
  factory _$$KitModelImplCopyWith(
          _$KitModelImpl value, $Res Function(_$KitModelImpl) then) =
      __$$KitModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? cod,
...
/// @nodoc
class __$$KitModelImplCopyWithImpl<$Res>
    extends _$KitModelCopyWithImpl<$Res, _$KitModelImpl>
    implements _$$KitModelImplCopyWith<$Res> {
  __$$KitModelImplCopyWithImpl(
      _$KitModelImpl _value, $Res Function(_$KitModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$KitModelImpl extends _KitModel {
  _$KitModelImpl(
      {required this.cod,
  ...
  _$$KitModelImplCopyWith<_$KitModelImpl> get copyWith =>
      __$$KitModelImplCopyWithImpl<_$KitModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$KitModelImplToJson(
      this,
    );
  }
}

abstract class _KitModel extends KitModel {
  factory _KitModel(
      {required int? cod,
