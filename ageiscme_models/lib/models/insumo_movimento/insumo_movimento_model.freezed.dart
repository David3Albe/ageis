...
class _$InsumoMovimentoModelImpl extends _InsumoMovimentoModel {
  _$InsumoMovimentoModelImpl(
      ...
      required this.nroTotalFiscal,
      required this.precoNotaFiscal,
      required this.precoCusto3Albe,
      required this.precoVenda3Albe,
      required this.codEquipamentoInsumo,
      required this.codDestinoResiduos,
...
abstract class _InsumoMovimentoModel extends InsumoMovimentoModel {
  factory _InsumoMovimentoModel(
      ...
      required DepositoInsumoModel? deposito}) = _$InsumoMovimentoModelImpl;
