...
PecaModel _$PecaModelFromJson(Map<String, dynamic> json) {
  return _PecaModel.fromJson(json);
}
...
mixin _$PecaModel {
  ...
  @JsonKey(ignore: true)
  $PecaModelCopyWith<PecaModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PecaModelCopyWith<$Res> {
  factory $PecaModelCopyWith(PecaModel value, $Res Function(PecaModel) then) =
      _$PecaModelCopyWithImpl<$Res, PecaModel>;
  @useResult
  $Res call(
      {int? cod,
      String? peca,
...
/// @nodoc
class _$PecaModelCopyWithImpl<$Res, $Val extends PecaModel>
    implements $PecaModelCopyWith<$Res> {
  _$PecaModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PecaModelImplCopyWith<$Res>
    implements $PecaModelCopyWith<$Res> {
  factory _$$PecaModelImplCopyWith(
          _$PecaModelImpl value, $Res Function(_$PecaModelImpl) then) =
      __$$PecaModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? cod,
...
/// @nodoc
class __$$PecaModelImplCopyWithImpl<$Res>
    extends _$PecaModelCopyWithImpl<$Res, _$PecaModelImpl>
    implements _$$PecaModelImplCopyWith<$Res> {
  __$$PecaModelImplCopyWithImpl(
      _$PecaModelImpl _value, $Res Function(_$PecaModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$PecaModelImpl extends _PecaModel with DiagnosticableTreeMixin {
  _$PecaModelImpl(
      {required this.cod,
      required this.peca,
  ...
  factory _$PecaModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$PecaModelImplFromJson(json);
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PecaModel(cod: $cod, peca: $peca, codInstituicao: $codInstituicao, ativo: $ativo, ultimaAlteracao: $ultimaAlteracao, tstamp: $tstamp)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'PecaModel'))
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PecaModelImplCopyWith<_$PecaModelImpl> get copyWith =>
      __$$PecaModelImplCopyWithImpl<_$PecaModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PecaModelImplToJson(
      this,
    );
  }
}

abstract class _PecaModel extends PecaModel {
  factory _PecaModel(
      {required int? cod,
      ...
      @JsonKey(name: 'tStamp') required String? tstamp}) = _$PecaModelImpl;
  _PecaModel._() : super._();

  factory _PecaModel.fromJson(Map<String, dynamic> json) =
      _$PecaModelImpl.fromJson;
