...
ConsultaProcessosLeituraModel _$ConsultaProcessosLeituraModelFromJson(
    Map<String, dynamic> json) {
  return _ConsultaProcessosLeituraModel.fromJson(json);
}
...
mixin _$ConsultaProcessosLeituraModel {
  ...
  @JsonKey(ignore: true)
  $ConsultaProcessosLeituraModelCopyWith<ConsultaProcessosLeituraModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ConsultaProcessosLeituraModelCopyWith<$Res> {
  factory $ConsultaProcessosLeituraModelCopyWith(
          ConsultaProcessosLeituraModel value,
          $Res Function(ConsultaProcessosLeituraModel) then) =
      _$ConsultaProcessosLeituraModelCopyWithImpl<$Res,
          ConsultaProcessosLeituraModel>;
  @useResult
  $Res call(
      {DateTime? dataHora,
      DateTime? data,
...
/// @nodoc
class _$ConsultaProcessosLeituraModelCopyWithImpl<$Res,
        $Val extends ConsultaProcessosLeituraModel>
    implements $ConsultaProcessosLeituraModelCopyWith<$Res> {
  _$ConsultaProcessosLeituraModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ConsultaProcessosLeituraModelImplCopyWith<$Res>
    implements $ConsultaProcessosLeituraModelCopyWith<$Res> {
  factory _$$ConsultaProcessosLeituraModelImplCopyWith(
          _$ConsultaProcessosLeituraModelImpl value,
          $Res Function(_$ConsultaProcessosLeituraModelImpl) then) =
      __$$ConsultaProcessosLeituraModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {DateTime? dataHora,
...
/// @nodoc
class __$$ConsultaProcessosLeituraModelImplCopyWithImpl<$Res>
    extends _$ConsultaProcessosLeituraModelCopyWithImpl<$Res,
        _$ConsultaProcessosLeituraModelImpl>
    implements _$$ConsultaProcessosLeituraModelImplCopyWith<$Res> {
  __$$ConsultaProcessosLeituraModelImplCopyWithImpl(
      _$ConsultaProcessosLeituraModelImpl _value,
      $Res Function(_$ConsultaProcessosLeituraModelImpl) _then)
      : super(_value, _then);
...
class _$ConsultaProcessosLeituraModelImpl
  ...
  factory _$ConsultaProcessosLeituraModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ConsultaProcessosLeituraModelImplFromJson(json);
  ...
  _$$ConsultaProcessosLeituraModelImplCopyWith<
          _$ConsultaProcessosLeituraModelImpl>
      get copyWith => __$$ConsultaProcessosLeituraModelImplCopyWithImpl<
          _$ConsultaProcessosLeituraModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ConsultaProcessosLeituraModelImplToJson(
      this,
    );
  }
}
...
abstract class _ConsultaProcessosLeituraModel
  ...
  factory _ConsultaProcessosLeituraModel.fromJson(Map<String, dynamic> json) =
      _$ConsultaProcessosLeituraModelImpl.fromJson;
