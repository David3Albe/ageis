...
class ItemMenuService {
  List<ItemMenuModel> getItems() {
    ...
    _criarItemsCadastro(itens);
    _criarItensColaborador(itens);
    _criarItensInsumo(itens);
    _criarItensEquipamento(itens);
    _criarItensProcesso(itens);
    _criarItensMaterial(itens);
    _criarItensArsenal(itens);
    _criarItensBiblioteca(itens);
    return itens;
  }

  void _criarItemsCadastro(List<ItemMenuModel> itens) {
  ...
  void _criarItensColaborador(List<ItemMenuModel> itens) {
  ...
  void _criarItensInsumo(List<ItemMenuModel> itens) {
    ...
    menuItemInsumo.addChildren(
      ItemMenuModel(
        'Cad. de Insumos',
        route: '/insumo/insumo',
        rights: [DireitoEnum.InsumosConsulta, DireitoEnum.InsumosManutencao],
      ),
    );
  ...
  void _criarItensEquipamento(List<ItemMenuModel> itens) {
  ...
  void _criarItensProcesso(List<ItemMenuModel> itens) {
  ...
  void _criarItensMaterial(List<ItemMenuModel> itens) {
    ...
    menuItemMateriais.addChildren(
      ItemMenuModel(
        ...
        rights: [
          DireitoEnum.KitsConsulta,
          DireitoEnum.MotivoReporRemoverItens,
        ],
      ),
    );
    ...
    menuItemMateriais.addChildren(
      ItemMenuModel(
        ...
        rights: [
          DireitoEnum.ProcessoAutorizarReporRemoverItem,
        ],
      ),
    );
  ...
  void _criarItensArsenal(List<ItemMenuModel> itens) {
  ...
  void _criarItensBiblioteca(List<ItemMenuModel> itens) {
